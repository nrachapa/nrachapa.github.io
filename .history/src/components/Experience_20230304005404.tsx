...
export default function Experience({}: Props) {
  return (
    ...
    >
      ...
      <div className="absolute w-full flex space-x-5 overflow-x-scroll p-0 snap-x snap-mandatory mt-43 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80">
        {/* -------------------------------- */}
