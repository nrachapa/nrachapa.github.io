    ...
    <motion.div className="flex relative flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-y-0 mx-auto items-center">
      ...
      <div className="grid grid-cols-4 gap-8">
        ...
        <SkillBubble
          ...
          prof={100}
        />
        <SkillBubble src={tensor_logo.src} skillName="AWS" prof={100} />
        <SkillBubble src={tensor_logo.src} skillName="C" prof={100} />
        <SkillBubble src={tensor_logo.src} skillName="C++" prof={100} />
        <SkillBubble src={tensor_logo.src} skillName="Databricks" prof={100} />
        <SkillBubble src={tensor_logo.src} skillName="Docker" prof={100} />
        <SkillBubble src={tensor_logo.src} skillName="Flask" prof={100} />
