      ...
      <div className="w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory mt-20">
        ...
        <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#272727] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
          ...
          <div className="px-0 md:px-10">
            ...
            <div className="mb-5">
              <div className="uppercase py-5 text-gray-300 mb-0">
                <span className="underline uppercase text-gray-300">
                  Skills
                </span>
                <p>
                  Python | AWS S3 | AWS SageMaker | AWS ECR | Matplotlib |
                  Seaborn | Grafana | Docker
                </p>
              ...
              <div className="h-80 overflow-y-scroll">
                <ul className="list-disc space-y-4 ml-5 text-lg">
                  <li>
                    Designed statistical models improving validation efficiency
                    by 70% through analyzing time-series telemetry data for
                    hardware and software validation across satellite subsystems
                    and test procedures.
                  </li>
                  <li>
